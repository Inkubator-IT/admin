...
const BlogListPage = () => {
  ...
  const filteredBlogs = useMemo(() => {
    return blogs.filter((blog) => {
      ...
      const matchesDate = !selectedDate || blog.created_at.startsWith(selectedDate);
  ...
  const error = blogsError ? (blogsError instanceof Error ? blogsError.message : "Failed to fetch blogs") : null;
