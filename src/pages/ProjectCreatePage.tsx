...
const ProjectCreatePage = () => {
	...
	return (
		<div className="p-8">
			<MetaTags
				title="Buat Project Baru - Admin Dashboard Inkubator IT"
				description="Buat portfolio project baru untuk website Inkubator IT"
				keywords="buat project, portfolio, inkubator it, admin"
			/>
			<div className="mb-8">
				<h1 className="text-3xl font-bold text-gray-900 mb-2">
					Create Project
				</h1>
				<p className="text-gray-600">Add new project to your portfolio</p>
			</div>
