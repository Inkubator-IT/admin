...
export const apiService = {
  ...
  getAllClientInformation: clientInformationApi.getAllClientInformation.bind(clientInformationApi),
  getClientInformationById: clientInformationApi.getClientInformationById.bind(clientInformationApi),
  createClientInformation: clientInformationApi.createClientInformation.bind(clientInformationApi),
  updateClientInformation: clientInformationApi.updateClientInformation.bind(clientInformationApi),
  deleteClientInformation: clientInformationApi.deleteClientInformation.bind(clientInformationApi),
};
